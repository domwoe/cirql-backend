...
Roomclimate.prototype.computeVentilationTime = function() {
    ...
    log.info({
        home: this.homeId,
        room: this.roomId
    }, " Roomclimate-Analytics: Best co2-dec-speed is currently " + bestCo2PerMin);
    this.fbRefAnalytics.child("co2-dec-speed").set(bestCo2PerMin);
};
