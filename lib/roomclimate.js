                            ...
                            if (state === 'green') {
                                ...
                                if (lang === 'en') {
                                    if (self.stateCO2 !== null && self.stateCO2 !== 'green') {
                                        param = {'value': self.co2};
                                        eventData = helper.createRawEvent('co2-green',param);
                                ...
                                if (lang === 'en') {
                                    if (self.stateCO2 !== null && self.stateCO2 !== 'yellow') {
                                        param = {'value': self.co2};
                                        eventData = helper.createRawEvent('co2-yellow',param);
                                        self.fbRefActivity.push(eventData);
                                    }
                                ...
                                if (lang === 'en') {
                                    if (self.stateCO2 !== null && self.stateCO2 !== 'red') {
                                        param = {'value': self.co2};
