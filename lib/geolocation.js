            ...
            if (this.regions.reg1) {
                ...
                if (this.regions.reg1.isInside === true) {
                    for (var regionKey in this.regions) {
                        ...
                        if (currRegionDate > this.homeRegionDate + 5 * 60) {
                            if (currRegion.isInside === false) {
                                farAwayRegionLeft = true;
                            }
                        }
                    }
                    if (!farAwayRegionLeft) {
                        ...
                        log.warn({
                            home: self.homeid,
                            user: self.userId
                        }, ' Geolocation: Reg1 was overwritten since a more far away region has been left!');
                    }
                }
            } else {
                this.homeRegionSeen = false;
