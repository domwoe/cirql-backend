                                ...
                                if (region.isInside === false) {
                                    ...
                                    if (regionKey === 'reg1') {
                                        log.warn({
                                            home: this.homeId,
                                            user: this.userId
                                        }, ' Geolocation-HomeRegion-Overwrite: It was set to at home by lastLocByUser');
                                    } else {
                                        log.warn({
                                            home: this.homeId,
                                            user: this.userId
                                        }, ' Geolocation-Region-Overwrite: Region ' + regionKey + 'was set to Inside by lastLocByUser');
                                    }
                                }
                            } else {
                                if (region.isInside === true) {
                                    ...
                                    if (regionKey === 'reg1') {
                                        log.warn({
                                            home: this.homeId,
                                            user: this.userId
                                        }, ' Geolocation-HomeRegion-Overwrite: It was set to away by lastlocbyUser');
                                    } else {
                                        log.info({
                                            home: this.homeId,
                                            user: this.userId
