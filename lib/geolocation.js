                                ...
                                if (region.isInside === false) {
                                    ...
                                    if (regionKey === 'reg1') {
                                        log.warn({
                                            home: this.homeid,
                                            user: this.userId
                                        }, ' Geolocation-HomeRegion-Overwrite: Region ' + regionKey + 'was overwritten by lastLocByUser');
                                    } else {
                                        log.warn({
                                            home: this.homeid,
                                            user: this.userId
                                        }, ' Geolocation-Region-Overwrite: Region ' + regionKey + 'was overwritten by lastLocByUser');
                                    }
                                }
                            } else {
