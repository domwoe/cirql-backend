...
Geolocation.prototype.checkHomeAway = function() {
    ...
    if (this.homeRegionSeen) {
        if (this.insideHomeRegion !== null) {
            if (this.insideHomeRegion) {
            ...
            log.warn({
                home: this.homeId,
                user: this.userId
            }, ' Geolocation: HomeRegion isInside field is not set! Strange! ');
        }
    } else {
        if (this.eta <= this.maxEtaForAtHome) {
            ...
            log.info({
                home: this.homeId,
                user: this.userId
            }, ' Geolocation: Resident is not at home by ETA but we do not set it!');
        }
    }
};
