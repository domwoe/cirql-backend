...
var tables = {
	...
	thermostats: sql.define({
	  name: 'thermostats',
	  columns: ['id', 'homeid', 'roomid', 'thermostatid', 'date', 'timestamp', 'value', 'type']
	}),
	...
	views: sql.define({
	  name: 'views',
	  columns: ['id', 'homeid', 'roomid', 'residentid', 'date', 'timestamp', 'view']
	}),
	...
	residents: sql.define({
		name: 'residents',
		columns: ['id', 'homeid', 'roomid','residentid', 'name','date', 'timestamp', 'value', 'type']
	}),

	geofencing: sql.define({
		name: 'geofencing',
		columns: ['id', 'homeid', 'residentid', 'date', 'timestamp', 'isfarerthan', 'iscloserthan']
	}),

	geolocation: sql.define({
		name: 'geolocation',
		columns: ['id', 'homeid', 'residentid', 'date', 'timestamp', 'distance', 'eta', 'lat', 'lng']
	}),

	notifications: sql.define({
		name: 'notifications',
		columns: ['id', 'homeid', 'roomid', 'residentid', 'date', 'timestamp', 'reason', 'msg']
	})
