...
function Heating(homeId, roomId) {
  ...
  this.fbRefIsAutoAway.on('value', function(fbData) {
  		log.info({home: this.homeId, room: this.roomId}, 'Heating: AutoAway change '+fbData.val());
  ...
  this.fbRefTemperature.on('value', function(fbData) {
    log.info({home: this.homeId, room: this.roomId}, 'Heating: Temperature change: '+fbData.val());
 ...
 this.fbRefEta.on('value', function(fbData) {
 	log.info({home: this.homeId, room: this.roomId}, 'Heating: ETA change '+fbData.val());
  	this.eta = fbData.val();
  	this.planNextTarget();
