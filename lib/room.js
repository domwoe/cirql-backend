...
Room.prototype.updateRoomTemperature = function() {
    ...
    if (this.netatmo !== null) { //there is a netatmo
...
//     var netatmoReady = true;
//     var hasNetatmo;

//     if (this.netatmo !== null) {
//         hasNetatmo = true;
//         if (this.netatmo.getTimestamp !== null) {
...
//     if (netatmoRedy === true || hasNetatmo === false) {


//         if (hasNetatmo && netatmoUpToDate) {
//             if (this.temperature !== this.netatmo.getTemperature()) {
//                 log.info({
//                     home: this.homeId,
//                     room: this.id
