...
function Room(homeId, roomId) {
    ...
    //                     if (fbEta) {
    //                         self.residentEtas[residentId] = fbEta.val();
    //                         log.info({
    //                             home: this.homeId,
    //                             room: this.id
    ...
    //                     if (fbIsAway) {
    //                         self.residentAways[residentId] = fbIsAway.val();
    //                         log.info({
    //                             home: this.homeId,
    //                             room: this.id
    ...
    //                                 home: this.homeId,
    //                                 room: this.id
    //                             }, ' Room: AllowGeo of resident ' + residentId + ' has changed ');
    ...
    //                                 }
    //                                 delete self.residentEtas[residentId];
    //                                 delete self.residentAways[residentId];
    //                                 this.calcMinEta();
    //                                 this.calcAwayState();
    ...
    //                         if (self.residentFbRefs[residentId] !== null && self.residentFbRefs[residentId] !== undefined) {
    //                             log.info({
    //                                 home: this.homeId,
    //                                 room: this.id
    ...
    //                             }
    //                             delete self.residentFbRefs[residentId];
    //                             if (self.residentEtas[residentId] !== null && self.residentEtas[residentId] !== undefined) {
    //                                 delete self.residentEtas[residentId];
    //                             }
    //                             if (self.residentAways[residentId] !== null && self.residentAways[residentId] !== undefined) {
    //                                 delete self.residentAways[residentId];
    //                             }
    //                             if (Object.keys(self.residentFbRefs).length !== 0) {
    //                                 this.calcMinEta();
    //                                 this.calcAwayState();
    ...
    //         }, this);
    //     } else {
    //         for (var residentKey in self.residentFbRefs) {
    //             if (callback1 !== null && callback2 !== null && callbackAllowGeo !== null) {
    //                 self.residentFbRefs[residentKey].child('allowsGeolocation').off('value', callbackAllowGeo, this);
    //                 self.residentFbRefs[residentKey].child('eta').off('value', callback1, this);
    //                 self.residentFbRefs[residentKey].child('isAway').off('value', callback2, this);
    //             }
    //         }
