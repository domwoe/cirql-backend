...
function get(resource, cb) {
    ...
    if (this.sessionId === null && resource !== '/sessions') {
...
Nefit.prototype.setTrvAddress = function(trvAddress, radiatorId, cb) {
    ...
    var ressource = '/heatingCircuits/hc1/radiator/radiator' + radiatorId + '/physAddr';
...
Nefit.prototype.getTrvAddress = function(radiatorId, cb) {
    ...
    var resource = '/heatingCircuits/hc1/radiator/radiator' + radiatorId + '/physAddr';
...
Nefit.prototype.getTarget = function(radiatorId, cb) {
    ...
    var resource = '/heatingCircuits/hc1/radiator/radiator' + radiatorId + '/radiatorSP';
