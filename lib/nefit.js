...
function put(resource, data, cb) {
  ...
  options.json = true;
  options.body = data;
  console.log('RESSOURCE: '+JSON.stringify(resource));
  console.log('OPTIONS: '+JSON.stringify(options));
...
function Nefit(homeId, uuid, userPw, devicePw) {
  ...
  this.sessionId = '79fd0852-ca5a-4d05-9955-8d6577e912d1-308011323';
...
Nefit.prototype.setTrvAddress = function(trvAddress,radiatorId,cb) {
  ...
  var ressource = '/sessions/'+this.sessionId+'/heatingCircuits/hc1/radiator/radiator'+radiatorId+'/physAddr';
  
  var data = {
    value: trvAddress
  };

  put(ressource,data,cb);
...
Nefit.prototype.getTarget = function(radiatorId,cb) {
  ...
  var ressource = '/sessions/'+this.sessionId+'/heatingCircuits/hc1/radiator/radiator'+radiatorId+'/radiatorSP';
