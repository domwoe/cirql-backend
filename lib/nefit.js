...
Nefit.prototype.pushToQueue = function(radiatorId, fnName, fn) {
    ...
    for (var i = 0, j = this.requestQueue.length; i < j; i++) {
        ...
        if (typeof this.requestQueue[i] === 'object' && 
            this.requestQueue[i].hasOwnProperty('radiatorId')
            ...
            console.log('RadiatorId: '+this.requestQueue[i].radiatorId);
            console.log('fnName: '+this.requestQueue[i].fnName);
            console.log('fn: '+this.requestQueue[i].fn);
        }    
    }
