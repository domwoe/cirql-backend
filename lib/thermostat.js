...
Thermostat.prototype.save = function() {
    ...
    //  console.log('saveTimeout: '+this.saveTimeout);
    // console.log('--------------------------------');
    if (this.saveTimeout === null) {
        this.saveTimeout = setTimeout(function() {
            // console.log('--------------------------------');
            // console.log('INSIDE TIMEOUT');
            // console.log('Valve: '+self.valve);
            // console.log('Temp: '+self.temperature);
            // console.log('Temp: '+self.fhemTargetTemperature);

            if (self.valve && self.temperature && self.fhemTargetTemperature) {
                var obj = {
                    table: 'thermostats',
                    data: {
                        homeid: self.homeId,
                        roomid: self.roomId,
                        thermostatid: self.thermostatId,
                        valve: self.valve,
...
Thermostat.prototype.bind = function(theRoom) {
    this.fbRefThermostat.child('fhem_measured-temp').on('value', function(fbThermostatTemperature) {
            ...
            if (fbThermostatTemperature.val()) {
                console.log(fbThermostatTemperature.val());
    ...
    this.fbRefThermostat.child('fhem_actuator').on('value', function(fbThermostatValve) {
            ...
            if (fbThermostatValve.val()) {
                console.log(fbThermostatValve.val());
